...
def save_image_and_steering_angle(video_file):
    ...
    try:
        ...
        while cap.isOpened():
            ...
            # print("/home/soumya/Self-Driving-Car/Behavioral_Cloning/Training/steering_data/image/%s_%03d_%03d.png" % (video_file, i, curr_steering_angle))
            cv2.imwrite("/home/soumya/Self-Driving-Car/Behavioral_Cloning/Training/steering_data/image/%s_%03d_%03d.png" % (video_file, i, curr_steering_angle), frame)
