...
if __name__ == '__main__':
    ...
    if mode == 'video':
        video_path = r"C:\Users\SOUMYA\Documents\GitHub\Important\Project\Embedded ML\SELF DRIVING CAR\Lane_prediction\project_video.mp4"
        # video_path = 0
        ...
        test_img_dir = r"C:\Users\SOUMYA\Documents\GitHub\Important\Project\Embedded ML\SELF DRIVING CAR\Lane prediction\test_images\test1.jpg"
        frame = cv2.imread(test_img_dir)
        blend = process_pipeline(frame, mtx, dist, keep_state=False)
        plt.imshow(cv2.cvtColor(blend, code=cv2.COLOR_BGR2RGB))
        plt.show()
